...
ALTER TABLE batches ADD COLUMN IF NOT EXISTS principal_id  TEXT;
ALTER TABLE batches ADD COLUMN IF NOT EXISTS errors        TEXT NOT NULL DEFAULT '[]';
ALTER TABLE batches ADD COLUMN IF NOT EXISTS cancelling_at BIGINT;
ALTER TABLE batches ADD COLUMN IF NOT EXISTS expired_at    BIGINT;

ALTER TABLE batch_requests ADD COLUMN IF NOT EXISTS url           TEXT   NOT NULL DEFAULT '';
ALTER TABLE batch_requests ADD COLUMN IF NOT EXISTS input_offset  BIGINT NOT NULL DEFAULT 0;
ALTER TABLE batch_requests ADD COLUMN IF NOT EXISTS input_length  BIGINT NOT NULL DEFAULT 0;
ALTER TABLE batch_requests ADD COLUMN IF NOT EXISTS status_code   BIGINT NOT NULL DEFAULT 0;
ALTER TABLE batch_requests ADD COLUMN IF NOT EXISTS response_body BYTEA;
ALTER TABLE batch_requests ADD COLUMN IF NOT EXISTS error_code    TEXT   NOT NULL DEFAULT '';

-- The files table renders an OpenAI file object, which carries status_details.
ALTER TABLE files ADD COLUMN IF NOT EXISTS status_details TEXT NOT NULL DEFAULT '';
